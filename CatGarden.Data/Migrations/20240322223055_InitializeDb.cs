    ...
    public partial class InitializeDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CatteryOwners", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CatteryOwners_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Catteries_CatteryOwners_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "CatteryOwners",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoatColor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    DateAdded = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CatteryId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Cats_Catteries_CatteryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersFavCats", x => new { x.UserId, x.CatId });
                    table.ForeignKey(
                        name: "FK_UsersFavCats_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Catteries_OwnerId",
                table: "Catteries",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_CatteryOwners_UserId",
                table: "CatteryOwners",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_CatteryId",
                table: "Reviews",
                column: "CatteryId");
